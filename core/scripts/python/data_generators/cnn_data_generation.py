...
class DataGenerator:
    ...
    def __init__(self, params_filename='parameters.yaml', dataset_count=2500, num_gaussians=5, num_robots=15, new_sz=128, num_steps_per_dataset=1, stable_dataset_count=10, num_neighbor_robots=3):
        ...
        self.coverage_maps = torch.empty(self.dataset_count, 2, self.new_sz, self.new_sz)
    ...
    def StepSave(self):
        ...
        for i in range(0, self.num_robots):
            ...
            self.coverage_maps[self.coverage_count, 0] = torch.tensor(lmap)
            ...
            self.coverage_maps[self.coverage_count, 1] = torch.tensor(comm_map)
