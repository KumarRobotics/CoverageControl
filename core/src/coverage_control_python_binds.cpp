...
PYBIND11_MODULE(pyCoverageControl, m) {
	...
	py::class_<CoverageSystem>(m, "CoverageSystem")
		...
		.def("GetRobotVoronoiFeatures", py::overload_cast<int>(&CoverageSystem::GetRobotVoronoiFeatures), py::return_value_policy::copy)
		.def("GetRobotVoronoiFeatures", py::overload_cast<>(&CoverageSystem::GetRobotVoronoiFeatures), py::return_value_policy::copy)
		.def("GetRobotExplorationFeatures", py::overload_cast<int>(&CoverageSystem::GetRobotExplorationFeatures), py::return_value_policy::copy)
